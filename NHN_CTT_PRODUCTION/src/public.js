...
export async function publicRoute(request,env,url){
  ...
  if(p==="/api/config"&&request.method==="GET"){
    ...
    return json({
      ...
      hero_text:await getSetting(env,"hero_text","Cổng thông tin, hoạt động, bảng tin, hồ sơ và xác thực Giấy chứng nhận của Nhà Hán Ngữ."),
      ...
      facebook_url:await getSetting(env,"facebook_url","https://www.facebook.com/nhahanngu.vn"),
      tiktok_url:await getSetting(env,"tiktok_url","https://www.tiktok.com/@nhahanngu"),
      home_intro_title:await getSetting(env,"home_intro_title","Một ứng dụng thống nhất cho cộng đồng Nhà Hán Ngữ"),
      home_intro_text:await getSetting(env,"home_intro_text",""),
      ...
      about_title:await getSetting(env,"about_title","Nhà Hán Ngữ là gì?"),
      about_body:await getSetting(env,"about_body",""),
      support_title:await getSetting(env,"support_title","Hỗ trợ & phản hồi"),
      support_body:await getSetting(env,"support_body","")
    });
  }
