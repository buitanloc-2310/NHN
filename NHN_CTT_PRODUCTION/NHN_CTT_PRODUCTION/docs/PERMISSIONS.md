...
- Quyền `member`, `volunteer`, Admin phải do NHN cấp.
...
- Tài khoản Super Admin gốc được tạo ở bước khởi tạo đầu tiên và không thể bị tài khoản khác khóa hoặc gỡ quyền Super Admin.
