...
async function openAccountAccess(){
  try{
    ...
    modal(`<button onclick="closeModal()">Đóng</button>
      ...
      <div class="notice bad"><p>Hệ thống chưa đọc được trạng thái khởi tạo quản trị từ cơ sở dữ liệu.</p></div>
      <p class="muted">Vui lòng không thử tài khoản hoặc mật khẩu mặc định. Kiểm tra D1/migration rồi tải lại trang.</p>
